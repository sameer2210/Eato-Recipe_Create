...
const About = () => {
  return (
    <section
      className="about lg:py-24 bg-gradient-to-br from-pink-100 via-white to-green-50 py-2 px-3 sm:py-4 sm:px-5 lg:px-8"
      id="about"
    >
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="banner order-2 lg:order-1">
            ...
            <div className="mid mb-10">
              ...
              <p className="text-gray-700 text-lg leading-relaxed">
                ...
                repellendus. Our passion for culinary excellence drives
                everything we do.
              </p>
            </div>
        ...
        <div className="mt-20 pt-16 border-t border-gray-200">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            <div className="text-center group cursor-pointer">
              <div className="text-3xl md:text-4xl font-bold  mb-2 transition-transform duration-300 group-hover:scale-110">
                500+
              </div>
        ...
        <div className="mt-16">
          <div className="grid md:grid-cols-2 gap-24">
            <div className="text-center p-6 bg-orange-50 hover:bg-orange-100 rounded-xl shadow-md hover:shadow-lg  duration-300">
            ...
            <div className="text-center p-6 bg-orange-50 hover:bg-orange-100  rounded-xl shadow-md hover:shadow-lg  duration-300">
              ...
              <p className="text-gray-600">
                Only the finest ingredients in every meal
              </p>
            </div>
          </div>
        </div>
